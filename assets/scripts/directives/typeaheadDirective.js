...
/**
 * @ngdoc directive
 * @name planApp.directive:typeahead
 * @description
 * # typeahead
...
angular.module('planApp')
  .directive('typeahead', function ($timeout) {
    return {
      ...
      transclude: true,
      replace: true,
      template: '<div><form><input ng-model="term" ng-change="query()" type="text" autocomplete="off" required/></form><div ng-transclude class="col s12"></div></div>',
      scope: {
        search: "&",
        select: "&",
        items: "=",
...
/**
 * @ngdoc directive
 * @name planApp.directive:typeaheadItem
 * @description
 * # typeaheadItem
 * Directive of the planApp
 */
